...
@aot_dso_cache = dso_local local_unnamed_addr global [810 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 u0x03ef7e715db9b387, ; from name: libaot-TrackingApp1.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	}, ; 11
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 u0x420aaa4a26ec4545, ; from name: libaot-TrackingApp1
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x4e664345be9035c2, ; from name: aot-TrackingApp1
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x63f117cb49d12c1d, ; from name: aot-TrackingApp1.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x699daf7cfd8299be, ; from name: TrackingApp1
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x8a093437fa4c9ddb, ; from name: aot-TrackingApp1.dll.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0x97ede479f2b437c0, ; from name: TrackingApp1.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xacf443413176ddf8, ; from name: TrackingApp1.dll.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
	...
	%struct.DSOCacheEntry {
		i64 u0xf96f40203d5368f0, ; from name: libaot-TrackingApp1.dll.so
		i64 u0xf96f40203d5368f0, ; uint64_t real_name_hash
		i1 false, ; bool ignore
		ptr @.DSOCacheEntry.8_name, ; name: libaot-TrackingApp1.dll.so
		ptr null; void* handle
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [29 x i8] c"com.companyname.trackingapp1\00", align 16
...
@.DSOCacheEntry.8_name = private unnamed_addr constant [27 x i8] c"libaot-TrackingApp1.dll.so\00", align 16
